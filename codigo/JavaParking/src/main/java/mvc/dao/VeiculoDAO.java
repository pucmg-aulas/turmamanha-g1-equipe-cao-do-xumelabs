...
public class VeiculoDAO extends AbstractDAO<Veiculo> implements Serializable {
    ...
    private VeiculoDAO() {
        super("C:\\Users\\paulo\\OneDrive\\Área de Trabalho\\JavaParkNovo\\turmamanha-g1-equipe-cao-do-xumelabs\\codigo\\JavaParking\\src\\main\\java\\mvc\\data\\Veiculos.dat");  // Define o caminho do arquivo .dat
    }
